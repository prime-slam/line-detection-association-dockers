# M-LSD Docker Image
This folder contains adapters for [M-LSD](https://github.com/navervision/mlsd) and a docker image
...
```
docker build -t mlsd -f Dockerfile ..
```
...
optional arguments:
  ...
  --model PATH, -M PATH
                        ...
                        /detector/tflite_models/M-LSD_512_tiny_fp32.tflite)
