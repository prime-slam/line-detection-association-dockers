# DeepLSD Docker Image
This folder contains adapters for [DeepLSD](https://github.com/cvg/DeepLSD) and a docker image
...
```
docker build -t deeplsd -f Dockerfile ..
```
...
optional arguments:
  ...
  --config PATH, -c PATH
                        ...
                        /detector/config/eval.yaml)
  --model PATH, -M PATH
                        pretrained model path (default:
                        /detector/weights/deeplsd_wireframe.tar)
```
